...
public class OCCColliders {
   ...
   public static final Collider YAMATO_US = new MultiOBBCollider(3, 0.46, 0.46, 1.32, 0.0, 0.0, -0.5);
   ...
   public static final Collider AERIAL_CLEAVE = new OBBCollider(0.6D, 2.4D, 1.8D, 0.0D, 1.25D, -0.75D);
